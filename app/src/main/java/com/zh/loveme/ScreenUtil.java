...
public class ScreenUtil {
    ...
    public static int getScreenWidth() {
        WindowManager wm = (WindowManager) App.mInstance
    ...
    public static int getStatusHeight() {
        ...
        try {
            ...
            statusHeight = App.mInstance.getResources().getDimensionPixelSize(height);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return statusHeight;
    ...
    public static int sp2px(float spValue) {
        float fontScale = App.mInstance.getResources().getDisplayMetrics().scaledDensity;
    ...
    public static int getScreenDensityDpi() {
        return App.mInstance.getResources().getDisplayMetrics().densityDpi;
    }
}
